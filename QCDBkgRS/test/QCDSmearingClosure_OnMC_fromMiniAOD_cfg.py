...
process.QCDfromSmearing.RebalanceCorrectionFile = '/afs/desy.de/user/s/sonnevej/xxl/CMSSW_7_4_15/src/AllHadronicSUSY/QCDBkgRS/test/QCDPrediction/RebalanceCorrectionFactor/RebalanceCorrectionFactors_madgraph_spring15_withoutPUReweighting_withNeutrinosEverywhere_DeadECALTP_recoPTbinspt10.root'
...
process.QCDfromSmearing.BTagEfficiencyFile = '/afs/desy.de/user/s/sonnevej/xxl/CMSSW_7_4_15/src/AllHadronicSUSY/QCDBkgRS/test/QCDPrediction/BTagEfficiency/B_Mis_TagEfficiencies_Spring15MadGraph_DeadECALTP.root'
