...
process.QCDfromSmearing.SmearingFile = '/afs/desy.de/user/s/sonnevej/xxl/CMSSW_7_4_15/src/AllHadronicSUSY/MCResolutions/data/QCD_13TeV_madgraph-MLM_finebins_bestMatching_angles_NeutrinosEverywhere_NeutrinosInBins_DeadECALTP_genPTbins_newsoftware.root'
...
#process.QCDfromSmearing.RebalanceCorrectionFile = '/afs/desy.de/user/s/sonnevej/xxl/CMSSW_7_4_15/src/AllHadronicSUSY/QCDBkgRS/test/QCDPrediction/RebalanceCorrectionFactor/RebalanceCorrectionFactors_madgraph_spring15_withoutPUReweighting_withNeutrinosEverywhere_DeadECALTP_genPTbins_newsoftwarept10.root'
process.QCDfromSmearing.RebalanceCorrectionFile = '/afs/desy.de/user/s/sonnevej/dust/RA2b_input/RebalanceCorrectionFactors_madgraph_spring15_withoutPUReweighting_withNeutrinosEverywhere_DeadECALTP_recoPTbins_newsoftwarept10.root'
...
process.QCDfromSmearing.BTagEfficiencyFile = '/afs/desy.de/user/s/sonnevej/xxl/CMSSW_7_4_15/src/AllHadronicSUSY/QCDBkgRS/test/QCDPrediction/BTagEfficiency/B_Mis_TagEfficiencies_Spring15MadGraph_DeadECALTP_genPTbins.root'
