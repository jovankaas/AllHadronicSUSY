...
int GetBinPrediction()
{
   ...
   //prediction_CoreUP->Process(predic_CoreUP);
   //prediction_CoreDN->Process(predic_CoreDN);
   //prediction_TailUP->Process(predic_TailUP);
   //prediction_TailDN->Process(predic_TailDN);
   ...
   //c->SaveAs("BinByBinClosure_MGMLM_bestMatching_algo_withRBcorr_pt10_angRes.pdf");
