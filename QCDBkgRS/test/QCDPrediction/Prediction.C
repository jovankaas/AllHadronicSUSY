...
Prediction::Prediction(TChain& QCDPrediction, TChain& RA2PreSelection)
{
   ...
   for ( ULong_t i = 0 ; i<nentries ; i++) {
      ...
      if( weight < 30000. ) {
         ...
         if( HT > HTSave && MHT > MHTSave && NJets >= NJetsSave && vtxN >= 0) {
   ...
   for ( Int_t i = 0 ; i<nentries2 ; i++) {
      ...
      if( weight_RA2 < 30000. ) {
         ...
         if( HT_RA2 > HTSave && MHT_RA2 > MHTSave && NJets_RA2 >= NJetsSave && NLeptons_RA2 == 0 && vtxN_RA2 >= 0) {
            ...
            if( HT_RA2 > 500. ) {
               ...
               else if( NJets_RA2 == 4 || NJets_RA2 == 5 ||  NJets_RA2 == 6 ) {
                  MHT_JetBin2_baseline_withoutDeltaPhi_sel->Fill(MHT_RA2, weight_RA2);
               }
               else if(  NJets_RA2 == 7  ||  NJets_RA2 == 8 ) {
