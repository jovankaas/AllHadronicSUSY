...
void GetRebalanceCorrectionFactor()
{
   ...
   TString outfile = "RebalanceCorrectionFactor/RebalanceCorrectionFactors_madgraph_spring15_withoutPUReweighting_withNeutrinosEverywhere_DeadECALTP_recoPTbins_newsoftware" + pt;
